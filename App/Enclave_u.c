...
sgx_status_t ecall_dijkstra_search(sgx_enclave_id_t eid, int* retval, const char* start_node, const char* end_node)
{
	sgx_status_t status;
	ms_ecall_dijkstra_search_t ms;
	ms.ms_start_node = start_node;
	ms.ms_start_node_len = start_node ? strlen(start_node) + 1 : 0;
	ms.ms_end_node = end_node;
	ms.ms_end_node_len = end_node ? strlen(end_node) + 1 : 0;
